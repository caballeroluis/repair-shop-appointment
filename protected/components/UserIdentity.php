...
//    } elseif (hash('sha512', $this->password) !== $cliente->password) { // comento esto porque la pass viaja encriptada desde cliente
...
//          $conexion = Yii::app()->db;
//          
//          $consulta = "SELECT username, password"
//                    . "FROM username"
//                    . "WHERE username='". $this->username."' AND"
//                    . "password='". $this->password."' AND activo=1";
//          
