...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'coste'); ?>
		<?php echo $form->textField($model,'coste'); ?>
		<?php echo $form->error($model,'coste'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'minutos_duracion'); ?>
		<?php echo $form->textField($model,'minutos_duracion'); ?>
		<?php echo $form->error($model,'minutos_duracion'); ?>
	</div>
