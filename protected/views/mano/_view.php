...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('coste')); ?>:</b>
	<?php echo CHtml::encode($data->coste); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('minutos_duracion')); ?>:</b>
	<?php echo CHtml::encode($data->minutos_duracion); ?>
	<br />
